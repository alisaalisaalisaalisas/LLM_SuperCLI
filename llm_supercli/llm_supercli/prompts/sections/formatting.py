...
class FormattingSection(PromptSection):
    ...
    def render(self, context: SectionContext) -> str:
        ...
        lines = [
            ...
            "## Reasoning (Optional)",
            "",
            "- For complex tasks, you may show your reasoning using <think>your thoughts</think> tags",
            "- Reasoning helps users understand your thought process",
            "- Keep reasoning concise and focused on the task",
            "",
            "## Tool Usage - IMPORTANT",
            "",
            "- NEVER use tools for simple greetings, questions, or conversations",
            "- Only use tools when the user EXPLICITLY asks to: read/write files, list directories, run commands",
            "- Do NOT use tools to 'explore' or 'understand context' unless asked",
            "- Do NOT call get_current_directory or list_directory just to answer questions",
            "- When in doubt, respond directly WITHOUT tools",
            "- Examples of when NOT to use tools: 'hi', 'what can you do', 'help me understand X'",
            "- Examples of when TO use tools: 'read file.py', 'create a new file', 'list files here'",
            "",
            "## Markdown Guidelines",
            "",
